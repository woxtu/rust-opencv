...
extern "C" {
  ...
  pub fn cvCreateTrackbar2(trackbar_name: *const c_char, window_name: *const c_char, value: *const c_int, count: c_int, on_change: extern "C" fn (pos: c_int, userdata: *const c_void), userdata: *const c_void) -> c_int;
  ...
  pub fn cvSetMouseCallback(window_name: *const c_char, on_mouse: extern "C" fn (event: c_int, x: c_int, y: c_int, flags: c_int, param: *const c_void), param: *const c_void);
